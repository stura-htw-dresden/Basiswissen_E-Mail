...
\subsecframe{Zugriff}{
	...
	\begin{tip}
    \item Zum Einrichten einer VPN Verbindung siehe die Anleitung des Rechenzentrums\footnote{\url{https://www.htw-dresden.de/rz/dienste/arbeitsplatz-und-kommunikation/virtual-private-network-vpn.html}}.
	\end{tip}
}
...
\subsecframe{Konto einrichten}{
	...
	\end{itemize}
    In einigen F\"allen ist es sinnvoll Informationen \"uber den Mail-Server des RZ\footnote{\url{https://www.htw-dresden.de/rz/dienste/arbeitsplatz-und-kommunikation/e-mail/einbindung-in-einen-mailclient.html}} zu haben.
	\begin{itemize}
		\item Incoming
	\begin{description}
		\item[Server hostname] groupware.htw-dresden.de
		\item[Port] 993
		\item[SSL] SSL/TLS
        ...
        \begin{column}{0.53\textwidth}  %%<--- here
            \begin{description}
                ...
                \item[Signature text:] Vorname Nachname\newline
                    ...
                    01069 Dresden
                \item[Outgoing Server (SMTP):] groupware.htw-dresden.de
            \end{description}
        \end{column}
    \end{columns}
}
